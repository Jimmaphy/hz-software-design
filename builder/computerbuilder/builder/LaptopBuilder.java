...
/**
 * The LaptopBuilder class is an implementation of the ComputerBuilder interface that builds laptops.
 * It allows users to specify the components of the laptop and then build the laptop object.
 */
public class LaptopBuilder implements ComputerBuilder {
    ...
    public Computer build() throws Exception {
        ...
        return new Computer(
            ComputerType.Laptop, this.computerCase, this.motherboard,
